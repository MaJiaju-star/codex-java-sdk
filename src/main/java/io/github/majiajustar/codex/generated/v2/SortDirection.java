...
// 来源：v2/ThreadListParams.json#/definitions/SortDirection
...
public enum SortDirection {
    ...
    public static SortDirection fromWireValue(String value) {
        for (var candidate : SortDirection.values()) {
            if (candidate.wireValue.equals(value)) return candidate;
        }
        throw new IllegalArgumentException("Unknown SortDirection value: " + value);
    }
}
